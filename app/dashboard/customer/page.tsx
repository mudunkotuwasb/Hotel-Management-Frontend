...
import NewBookingModal from "../customer/bookings/NewBookingModal";
...
const mockBookings: Booking[] = [
  { id: "1", roomId: "1", checkIn: "2024-01-15", checkOut: "2024-01-20", status: "checked-out", totalAmount: 500 },
  { id: "2", roomId: "2", checkIn: "2024-02-01", checkOut: "2024-02-05", status: "confirmed", totalAmount: 600 },
  { id: "3", roomId: "3", checkIn: "2024-03-10", checkOut: "2024-03-15", status: "pending", totalAmount: 1500 }
];
...
const getBookingStatus = (status: string) => {
  switch (status) {
    ...
    case 'pending':
      return { text: 'Pending', color: 'bg-yellow-100 text-yellow-800', icon: Calendar };
    case 'checked-out':
      return { text: 'Completed', color: 'bg-blue-100 text-blue-800', icon: CheckCircle };
    default:
      return { text: 'Unknown', color: 'bg-gray-100 text-gray-800', icon: Calendar };
  }
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-xl p-6 text-white">
            ...
            <p className="text-blue-100">Manage your bookings and explore our services</p>
          </div>
